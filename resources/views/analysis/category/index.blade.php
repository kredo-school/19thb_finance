                        ...
                        <table class="table p-0">
                            <thead>
                                <tr>
                                    ...
                                    <th style="background-color: #F7F3EB"></th>
                                    <th style="background-color: #F7F3EB"></th>
                                    <th class="small" style="background-color: #F7F3EB">Percentage of Total</th>
                                    <th class="small" style="background-color: #F7F3EB">Number of Events</th>
                                    <th class="small" style="background-color: #F7F3EB">Average of Events</th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach ($parentCategories as $parentCategory)
                                    <tr class="text-center align-middle">
                                        <td style="background-color: #{{ $parentCategory['color_hex'] }}">
