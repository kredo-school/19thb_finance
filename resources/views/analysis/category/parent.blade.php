                                        ...
                                        <div class="col">
                                            <table class="table">
                                                <tr class="align-middle">
                                                    ...
                                                    <td class="text-end" style="color: #FE6D73;">¥{{ number_format(floor($parentCategory['total_amount'])) }}</td>
                                                </tr>
                                                @foreach ($parentCategory['childCategories'] as $childCategory)
                                                    <tr class="align-middle">
                                                        ...
                                                        <td class="text-end border-0 pb-0">¥{{ number_format(floor($childCategory['total_amount'])) }}</td>
                                                    </tr>
                                                    <tr>
                                                        <td></td>
