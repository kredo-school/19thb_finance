        ...
        <div class="container">
            <div class="row justify-content-center">
                ...
                <div class="col-lg-6 p-4">
                    ...
                    {{-- Add Category --}}
                    <div class="card shadow border-0 p-5 my-3">
                                    ...
                                    <div class="row row-cols-4 gx-1">
                                        ...
                                        <div class="form-check p-0">
                                            ...
                                            <label class="btn p-1" for="transportation">
                                                <img src="{{ asset('images/category-icon/transportation.svg') }}" alt="transportation" width="30px">
                                            </label>
                                        </div>
                                        <div class="form-check p-0">
                                            <input class="btn-check" type="radio" id="education" value="education" name="icon_path">
                                            <label class="btn p-1" for="education">
                                                <img src="{{ asset('images/category-icon/education.svg') }}" alt="education" width="30px">
                                            </label>
                                        </div>
                                        <div class="form-check p-0">
                                            <input class="btn-check" type="radio" id="books" value="books" name="icon_path">
                                            <label class="btn p-1" for="books">
                                                <img src="{{ asset('images/category-icon/books.svg') }}" alt="books" width="30px">
                                            </label>
                                        </div>
                                        <div class="form-check p-0">
                                            <input class="btn-check" type="radio" id="medical" value="medical" name="icon_path">
                                            <label class="btn p-1" for="medical">
                                                <img src="{{ asset('images/category-icon/medical.svg') }}" alt="medical" width="30px">
                                            </label>
                                        </div>
                                        <div class="form-check p-0">
                                            <input class="btn-check" type="radio" id="investment" value="investment" name="icon_path">
                                            <label class="btn p-1" for="investment">
                                                <img src="{{ asset('images/category-icon/investment.svg') }}" alt="investment" width="30px">
                                            </label>
                                        </div>
                                        <div class="form-check p-0">
                                            <input class="btn-check" type="radio" id="expense1" value="expense1" name="icon_path">
                                            <label class="btn p-1" for="expense1">
                                                <img src="{{ asset('images/category-icon/expense1.svg') }}" alt="expense1" width="30px">
                                            </label>
                                        </div>
                                        <div class="form-check p-0">
                                            <input class="btn-check" type="radio" id="income1" value="income1" name="icon_path">
                                            <label class="btn p-1" for="income1">
                                                <img src="{{ asset('images/category-icon/income1.svg') }}" alt="income1" width="30px">
                                            </label>
                                        </div>
                                        <div class="form-check p-0">
                                            <input class="btn-check" type="radio" id="income2" value="income2" name="icon_path">
                                            <label class="btn p-1" for="income2">
                                                <img src="{{ asset('images/category-icon/income2.svg') }}" alt="income2" width="30px">
                                            </label>
                                        </div>
                                        <div class="form-check p-0">
                                            <input class="btn-check" type="radio" id="income3" value="income3" name="icon_path">
                                            <label class="btn p-1" for="income3">
                                                <img src="{{ asset('images/category-icon/income3.svg') }}" alt="income3" width="30px">
                                            </label>
                                        </div>
                                        <div class="form-check p-0">
                                            <input class="btn-check" type="radio" id="income4" value="income4" name="icon_path">
                                            <label class="btn p-1" for="income4">
                                                <img src="{{ asset('images/category-icon/income4.svg') }}" alt="income4" width="30px">
                                            </label>
                                        </div>
                                    </div>
                                    @error('icon_path')
