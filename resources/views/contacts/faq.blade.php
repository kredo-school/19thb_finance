...
<div class="container my-4">
    <div class="row justify-content-center">
        <div class="col-md-auto position-relative">
            ...
            <div class="row mb-2">
                <p class="h5 text-secondary text-center border border-3 rounded-3 shadow bg-white bg-opacity-50 mx-4 px-3 py-1" style="letter-spacing: .1rem; max-width: 160px; border: solid 3px #F7A072 !important;">{{ __('FAQ') }}</p>
            </div>
